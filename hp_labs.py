...
v = V( t )
fitted_solution = I( t, x_solve_ivp_fitted.y[ 0, : ] )
ax11 = axes[ 0 ]
ax11.plot( t, fitted_solution, color="b" )
ax11.set_ylabel( r'Current ($\mu A$)', color='b' )
# ax11.set_ylim([-30, 30])
ax11.tick_params( 'y', colors='b' )
ax12 = ax11.twinx()
...
residuals = noisy_solution - fitted_solution
fig4, axes = plt.subplots( 1, 2, figsize=(10, 4) )
axes[ 0 ].plot( fitted_solution, residuals )
